    ...
    <div class="row" style="margin-top: 24px;">
        ...
        <div class="row" style="margin-bottom: 24px;">
            <ul class="head-ul footlink">
                ...
                <li>
                    <select class="form-control" onchange="jumpMenu('parent',this,0)">
                        <option value="all" class="option">政府网站</option>
                        <option value="http://www.sdpc.gov.cn/" class="option">
                            中华人民共和国国家发展和改革委员会官方网站
                        </option>
                        <option value="http://gddrc.southcn.com" class="option" >
                            广东省发展和改革委员会官方网站
                        </option>
                    </select>
                </li>
                <li>
                    <select class="form-control" onchange="jumpMenu('parent',this,0)">
                        <option value="all" class="option">价格网站</option>
                        <option value="http://www.chinaprice.com.cn/" class="option">
                            中国价格信息网
                        </option>
                    </select>
                </li>
                <li>
                    <select class="form-control" onchange="jumpMenu('parent',this,0)">
                        <option value="all" class="option" >相关行业</option>
                        <option value="http://www.china-price.com.cn/" class="option">
                            中国价格协会
                        </option>
...
<script>
    ...
    function jumpMenu(tar,selObj,restore) {
        if(selObj.selectedIndex){
            eval(tar+".open('"+selObj.options[selObj.selectedIndex].value+"')");
        }
