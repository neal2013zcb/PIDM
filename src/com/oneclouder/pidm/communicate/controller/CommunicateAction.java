...
public class CommunicateAction {
     ...
     * @param communicateId
     */
    @RequestMapping(value = "back/communicate/deleteCommunicate",method = RequestMethod.GET)
    @ResponseBody
    public void deleteCommunicate(Integer communicateId){
        communicateService.deleteCommunicate(communicateId);
    }
}
